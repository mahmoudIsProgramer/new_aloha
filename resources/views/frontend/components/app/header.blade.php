                        ...
                        <div class="header-search ajax-search the-basics">
                            <form action="{{ route('products') }}" method="get">
                                ...
                                <div class="input-group">
                                    <input type="search" name='search' id='search' class="form-control typeahead"
                        ...
                        <div class="category-left">
                                    ...
                                    @foreach ($categoriesSidebar as $key => $category)
                                        <li class="categoryone">
                                            <a href="{{ route('products', ['category_id' => $category->id]) }}"
                                                class="cat-title">{{ $category->name }}
                                                <span class="arrow"></span></a>

                                            @if (count($category->childs))
                                                <ul>
                                                    @include('frontend.components.app.manageChild',['childs' =>
                                                    $category->childs])
                                                </ul>
                                            @endif
                                        </li>
                            ...
                            <div class="logo-block">
                                ...
                                <div class="brand-logo logo-sm-center">
                                    <a href="index.html ">
                                        <img src="{{ $siteOption->image_path }}" class="img-fluid  " alt="logo">
                                    </a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            @foreach ($categoriesSidebar as $key => $category)
                                                <ul>
                                                    <li>
                                                        ...
                                                        @include('frontend.components.app.manageChildMenu',['childs' =>
                                                        $category->childs])
                                                    </li>
                                                </ul>
                                            @endforeach
