                    ...
                    <div class="top-header-right">
                        <ul>
                            @if ($customer = getCustomer())
                                ...
                                <li>
                                    <a href="{{ route('customer.profile') }}"><i class="fa fa-user"></i>
                            ...
                            @else
                                <li> <a href="{{ route('customer.login') }}"><i class="fa fa-user"></i>
                                        Login/register</a>
                                    {{-- <li onclick="openAccount()"> <a href="javascript:void(0)"><i class="fa fa-user"></i>
                                    Login/register</a> --}}
                                </li>
                            @endif
                            <li><a href="go-register-seller.html"> start selling</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="header-contain">
                        <div class="logo-block">
                            ...
                            <div class="brand-logo logo-sm-center"> <a href="index.html"> <img
                                        src="{{ $siteOption->logo_path }}" class="img-fluid  " alt="logo">
                                </a>
                            </div>
                        </div>
                        <!-- If You don't need ajax search remove class (ajax-search) -->
                      ...
                      512;" xml:space="preserve">
                                ...
                                <li class="mobile-wishlist item-count icon-desk-none" onclick="openWishlist()">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512
                    ...
                    <div class="category-contain">
                        <div class="category-left">
                            <div class="header-category3">
                                <a class="category-toggle "><i class="ti-layout-grid2-alt"></i>Categories</a>
                                ...
                                <ul class="collapse-category open">
                                    ...
                                    @foreach ($categoriesSidebar as $key => $category)
                                        <li class="categoryone">
                                            <a href="{{ route('products', ['category_id'=>$category->id]) }}" class="cat-title">{{ $category->name }}
                                                <span class="arrow"></span></a>
                                            @foreach ($category->subcategories as $subcategory)
                                                <div class="collapse-mega">
                                                    <div class="mega-box">
                                                        <h5>{{ $subcategory->name }} <span class="sub-arrow"></span>
                                                        </h5>
                                                        <ul>
                                                            @foreach ($subcategory->subsubcategories as $subsubcategory)
                                                                <li><a href="{{ route('products', ['subusbcategory_id'=>$subsubcategory->id]) }}">
                                                                        {{ $subsubcategory->name }}</a></li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                </div>
                            ...
                            <div class="menu-block">
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <!-- With Dropdown -->
                                        <li>
                                            <a class="dark-menu-item" href="javascript:void(0)">Products</a>
                                            @foreach ($categoriesSidebar as $key => $category)
                                                <ul>
                                                    <li>
                                                        ...
                                                        @foreach ($category->subcategories as $subcategory)
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    <ul>
                                                                        @foreach ($subcategory->subsubcategories as $subsubcategory)
                                                                            <li><a href="category.html">{{ $subsubcategory->name }}
                                                                                </a>
                                                                            </li>
                                                                        @endforeach
                                                                    </ul>
                                        ...
                                        {{-- <li><a class="dark-menu-item" href="category.html">Bundles</a></li> --}}
                                        <li><a class="dark-menu-item" href="category.html">Offers</a></li>
                                        @foreach ($categoriesMenu as $category)
                                            <li><a class="dark-menu-item" href="category.html">
                                                    {{ $category->name }} </a></li>
                                        @endforeach
