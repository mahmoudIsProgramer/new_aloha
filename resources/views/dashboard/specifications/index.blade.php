...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('site.specifications')</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.specifications')
                <small>
                        @lang('site.total_search')
                        ( {{ $specifications->total() }} )
                </small></h3>

                <form action="{{ route('dashboard.specifications.index') }}" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            @if (auth()->user()->hasPermission('create_specifications'))
                            <a href="{{ route('dashboard.specifications.create') }}" class="btn btn-primary"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('dashboard.specifications.edit', $item->id) }}"
                                ...
                                <form action="{{ route('dashboard.specifications.destroy', $item->id) }}" method="post"
