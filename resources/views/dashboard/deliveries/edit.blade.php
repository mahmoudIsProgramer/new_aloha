  ...
  <section class="content">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <form action="{{ route('dashboard.deliveries.update',$delivery->id ) }}" method="post"
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select name='city_id' class="form-control city_id" required>
                  ...
                  <option value="{{$city->id}}" @if(old('city_id')==$city->id || $delivery->city_id == $city->id )
              ...
              {{-- <div class="form-group">
                ...
                <select name='status' class="form-control" required>
                  <option value="1" @if( (old('status')=='1' )||$delivery->status=='1') selected
                    @endif>@lang('site.Active')</option>
                  <option value="0" @if( (old('status')=='0' )||$delivery->status=='0') selected
                                ...
                                <div class="states">
                                    <select name='state_id' class="form-control state_id"   required >
                                        ...
                                        @foreach($states as $state )
                                            <option value="{{$state->id}}" @if(old('state_id') == $state->id ||
              $delivery->state_id == $state->id ) selected @endif>{{$state->name}}</option>
              @endforeach
              </select>
            </div> --}}
