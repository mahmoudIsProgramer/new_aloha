        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
              ...
              @if ($customer->have_deferred_account==1)

              <li class="list-group-item">
                <b><i class="fa fa-bus margin-r-5" aria-hidden="true"></i>
                  @lang('site.max_deferred_amount')</b>
                <a class="pull-right">
                  {!! $customer->max_deferred_amount !!}
                </a>
              </li>

              <li class="list-group-item">
                <b><i class="fa fa-bus margin-r-5" aria-hidden="true"></i>
                  @lang('site.used_deferred_amount')</b>
                <a class="pull-right">
                  {!! $customer->used_deferred_amount !!}
                </a>
              </li>
              @endif
              ...
              <li class="list-group-item">
                ...
                <img src="{{ $customer->image_path }}" style="width: 300px;height:200px" class="img-thumbnail" alt="">
              </li>
