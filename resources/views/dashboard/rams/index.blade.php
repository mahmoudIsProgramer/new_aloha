...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.rams')</h1>

            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a>
                </li>
                <li class="active">@lang('site.rams')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.rams')
                        <small>
                    ...
                    <form action="{{ route('dashboard.rams.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_rams'))
                                    <a href="{{ route('dashboard.rams.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>
                                        @lang('site.add')</a>
                                @else
                ...
                <div class="box-body">
                    ...
                    @if ($rams->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (auth()->user()->hasPermission('update_rams'))
                                                <a href="{{ route('dashboard.rams.edit', $item->id) }}"
                                            ...
                                            @if (auth()->user()->hasPermission('delete_rams'))
                                                <form action="{{ route('dashboard.rams.destroy', $item->id) }}"
                        ...
                        {{ $rams->appends(request()->query())->links() }}
