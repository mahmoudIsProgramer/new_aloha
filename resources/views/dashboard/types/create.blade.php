        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.types.store') }}" method="post" enctypes="multipart/form-data">
                        ...
                        {{-- <div class="form-group">
                          ...
                          <input types="file" id='image' name="image" class="form-control image2" enctypes="multipart/form-data">
                        </div>
