    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('site.types')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.types')
                        <small>
                    ...
                    <form action="{{ route('dashboard.types.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_types'))
                                    <a href="{{ route('dashboard.types.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>
                                        @lang('site.add')</a>
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (auth()->user()->hasPermission('update_types'))
                                                <a href="{{ route('dashboard.types.edit', $item->id) }}"
                                            ...
                                            @if (auth()->user()->hasPermission('delete_types'))
                                                <form action="{{ route('dashboard.types.destroy', $item->id) }}"
                                                    method="post" style="display: inline-block">
                                                    {{ csrf_field() }}
                                                    {{ method_field('delete') }}
                                                    <button types="submit" class="btn btn-danger delete btn-sm"><i
                                                            class="fa fa-trash"></i>
