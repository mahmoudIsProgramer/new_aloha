      ...
      <div class="box-header with-border">
        ...
        <form action="{{ route('dashboard.roles.index') }}" method="get">
          ...
          <div class="row">
            ...
            {{--<div class="col-md-4">
                                <select name="role" class="form-control">
                                    ...
                                    <option value="admin" {{ ( request()->role  && request()->role=="admin" ) ? "selected" :'' }}>
            @lang('site.admin') </option>
            <option value="sales" {{ ( request()->role  && request()->role=="sales" ) ? "selected" :'' }}>
              @lang('site.sales') </option>
            </select>
          </div>--}}
          ...
          <div class="col-md-4">
            ...
            <a href="{{ route('dashboard.roles.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
              @lang('site.add')</a>
            @else
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="{{ route('dashboard.roles.edit', $role->id) }}" class="btn btn-warning btn-sm"><i
