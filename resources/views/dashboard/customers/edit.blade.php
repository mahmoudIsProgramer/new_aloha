                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name='status' class="form-control" required>
                                        ...
                                        <option value="0" @if (old('status') == '0' || $customer->status == '0') selected @endif>@lang('site.In-Active')</option>
                                    </select>
                                </div>
                              ...
                              <div class="form-group">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select name='verified' class="form-control" required>
                                        <option value="1" @if (old('verified') == '1' || $customer->verified == '1') selected @endif>@lang('site.Active')</option>
                                        <option value="0" @if (old('verified') == '0' || $customer->verified == '0') selected @endif>@lang('site.In-Active')</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name='gender' class="form-control" required>
                                        <option value="male" @if (old('gender') == 'male' || $customer->gender == 'male') == 'male') selected @endif>@lang('site.male')
                                        </option>
                                        <option value="female" @if (old('gender') == 'female' || $customer->gender == 'female') == 'female')
                                          selected @endif>@lang('site.female')</option>
                                    </select>
                                </div>
                                <div class="form-group">
