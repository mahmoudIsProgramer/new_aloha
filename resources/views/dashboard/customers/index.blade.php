                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_customers'))
                                    <a href="{{ route('dashboard.customers.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>
                                        @lang('site.add')</a>
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (auth()->user()->hasPermission('update_customers'))
                                                <a href="{{ route('dashboard.customers.edit', $value->id) }}"
                                            ...
                                            @if (auth()->user()->hasPermission('delete_customers'))
                                                <form action="{{ route('dashboard.customers.destroy', $value->id) }}"
