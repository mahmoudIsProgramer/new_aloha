    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.materials.index') }}"> @lang('site.materials')</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.materials.update', $material->id) }}" method="post"
                        ...
                        <div class="form-group">
                          <img src="{{ $material ->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div> --}}
