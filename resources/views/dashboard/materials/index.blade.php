...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.materials')</h1>

            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a>
                </li>
                <li class="active">@lang('site.materials')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.materials')
                        <small>
                    ...
                    <form action="{{ route('dashboard.materials.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_materials'))
                                    <a href="{{ route('dashboard.materials.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>
                                        @lang('site.add')</a>
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (auth()->user()->hasPermission('update_materials'))
                                                <a href="{{ route('dashboard.materials.edit', $item->id) }}"
                                            ...
                                            @if (auth()->user()->hasPermission('delete_materials'))
                                                <form action="{{ route('dashboard.materials.destroy', $item->id) }}"
