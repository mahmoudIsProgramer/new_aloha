    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.reviews.index') }}"> @lang('site.reviews')</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.reviews.update', $reviews->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        @foreach (config('translatable.locales') as $key=> $locale)
                            ...
                            <div class="form-group">
                                ...
                                <input   type="text" name="{{ $locale }}[name]" class="form-control"  required="required"  value="{{ $reviews->translate($locale)->name }}">
                            </div>
