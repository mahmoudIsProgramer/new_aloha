    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.cities')
                <small>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('dashboard.cities.edit', $item->id) }}"
                                ...
                                <form action="{{ route('dashboard.cities.destroy', $item->id) }}" method="post"
