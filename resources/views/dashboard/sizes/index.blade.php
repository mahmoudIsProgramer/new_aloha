...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.sizes')</h1>

            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a>
                </li>
                <li class="active">@lang('site.sizes')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.sizes')
                        <small>
                    ...
                    <form action="{{ route('dashboard.sizes.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_sizes'))
                                    <a href="{{ route('dashboard.sizes.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>
                                        @lang('site.add')</a>
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (auth()->user()->hasPermission('update_sizes'))
                                                <a href="{{ route('dashboard.sizes.edit', $item->id) }}"
                                            ...
                                            @if (auth()->user()->hasPermission('delete_sizes'))
                                                <form action="{{ route('dashboard.sizes.destroy', $item->id) }}"
