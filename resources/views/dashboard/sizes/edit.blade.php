    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.sizes.index') }}"> @lang('site.sizes')</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.sizes.update', $size  ->id) }}" method="post"
                        ...
                        <div class="form-group">
                          <img src="{{ $size ->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div> --}}
