    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('site.colors')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.colors')
                        <small>
                    ...
                    <form action="{{ route('dashboard.colors.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_colors'))
                                    <a href="{{ route('dashboard.colors.create') }}" class="btn btn-primary"><i
                                            class="fa fa-plus"></i>
                                        @lang('site.add')</a>
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (auth()->user()->hasPermission('delete_colors'))
                                                <form action="{{ route('dashboard.colors.destroy', $item->id) }}"
