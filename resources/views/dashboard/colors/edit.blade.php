    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.colors.index') }}"> @lang('site.colors')</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.colors.update', $color  ->id) }}" method="post"
                        ...
                        <div class="form-group">
                          <img src="{{ $color ->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div> --}}
