        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.subsubcategories.store') }}"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name='subcategory_id' id  = 'subcategory_id' class="form-control" required >
                                ...
                                <option value="{{ $item->id}}" @if( old('subcategory_id') == $item->id ) selected  @endif>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
