    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.sims.index') }}"> @lang('site.sims')</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.sims.update', $sim  ->id) }}" method="post"
                        ...
                        <div class="form-group">
                          <img src="{{ $sim ->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div> --}}
