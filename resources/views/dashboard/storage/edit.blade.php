        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.storages.update', $storage  ->id) }}" method="post"
                        ...
                        <div class="form-group">
                          <img src="{{ $storage ->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div> --}}
