...
class Product extends Model
{
  ...
  public function getTotalBySeller($seller_id = null)
  {
    $seller = $this->selectedSeller(request()->seller_id ?? $seller_id);

    // dd($this);
    // dd($seller);
    // dd($seller->pivot->selling_price );
    // // dd( $seller->pivot->discount);
    // dd($seller->pivot->selling_price - $seller->pivot->discount);
  ...
  {
    return $this->belongsToMany(Customer::class, 'customer_product', 'customer_id', 'product_id')->withPivot(['qty']);
  }
